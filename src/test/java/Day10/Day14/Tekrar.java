...
public class Tekrar {
    ...
    public void readExcelTest2() throws IOException {
        ...
        FileInputStream fis = new FileInputStream(dosyaYolu); //oluşturmuş olduğumuz dosyayı sisteme aldık
        ...
        Row row = sheet.getRow(3);//excelde ki shhet le almış olduğumuz sayfanın satırını aldık
        ...
        Assert.assertTrue(expected.contains(cell.getStringCellValue()));
