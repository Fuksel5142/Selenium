...
public class TestCase4 {
    ...
    public void test() throws InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@data-qa='login-email']")).sendKeys("fuksel@gmail.com");
        driver.findElement(By.xpath("//input[@data-qa='login-password']")).sendKeys("123456");
        //7. Click 'login' button
        driver.findElement(By.xpath("//button[@data-qa='login-button']")).click();

        //8. Verify that 'Logged in as username' is visible
        WebElement loginButton = driver.findElement(By.xpath("//*[@id=\"header\"]/div/div/div/div[2]/div/ul/li[10]/a"));
