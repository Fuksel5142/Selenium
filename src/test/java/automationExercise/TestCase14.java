...
public class TestCase14 extends TestBase {
    ...
    public void test01() throws InterruptedException {
        ...
        action.click(nameElement).sendKeys(faker.name().fullName()).sendKeys(Keys.TAB).
                sendKeys(faker.internet().emailAddress()+ Keys.ENTER).perform();
        ...
        action.click().sendKeys(Keys.PAGE_DOWN).perform();
        ...
        jse2.executeScript("arguments[0].scrollIntoView(true);",textarea);
        textarea.sendKeys("Adam olun aklınızı alırım");
        driver.findElement(By.xpath("//*[text()='Place Order']")).click();
        //16. Enter payment details: Name on Card, Card Number, CVC, Expiration date
        WebElement NameCard = driver.findElement(By.xpath("//input[@class='form-control']"));
        action.click(NameCard).sendKeys(faker.name().fullName()).
